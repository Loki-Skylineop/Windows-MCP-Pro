...
_DESCRIPTION = (
    ...
    "  timeout  seconds, default 30 and effectively capped at 55 because the MCP client aborts "
    "the call at ~60s - use the Job tool for anything longer; the command's own exit code is "
    "reported, stdout and stderr "
