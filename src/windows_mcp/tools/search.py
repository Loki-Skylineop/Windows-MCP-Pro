...
_DESCRIPTION = (
    ...
    "'books' - catalogue records through Open Library (authors, first published, editions, "
    "languages), falling back to Google Books and then plain web search when a network "
    "blocks them; "
